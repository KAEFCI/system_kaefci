    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            <div class="history-wrapper">
                                ...
                                <td class="aksi">
                                    <div class="dropdown" data-id="{{ $row->id }}">
                                        ...
                                        <div class="dd-menu">
                                            ...
                                            <form method="POST" action="{{ route('history.karyawan.destroy',$row->id) }}" onsubmit="return confirm('Hapus history karyawan ini?')">
                                                @csrf
                                                @method('DELETE')
                ...
                @if(($data ?? null) && method_exists($data, 'links'))
